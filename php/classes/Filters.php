...
class Filters {
	 ...
	 *
	 * @param array|Filter $filters Filters to (potentially) use.
	 * {@see spliceFilters}
	 */
	function __construct(array|Filter $filters = []) {
	...
	// $filters
		 ...
		 *
		 * @param array|Filter $spliceDefs Splice definitions to fulfill. Either
		 * a single Filter, where that filter is pushed onto $this->filters, an
		 * array of splice definitions, or a single splice definition, where a
		 * splice definition is the following:
